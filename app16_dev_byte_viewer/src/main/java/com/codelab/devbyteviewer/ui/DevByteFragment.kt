package com.codelab.devbyteviewer.ui
...
import com.codelab.devbyteviewer.R
import com.codelab.devbyteviewer.databinding.DevbyteItemBinding
import com.codelab.devbyteviewer.databinding.FragmentDevByteBinding
import com.codelab.devbyteviewer.domain.DevByteVideo
import com.codelab.devbyteviewer.viewmodels.DevByteViewModel
...
class DevByteFragment : Fragment() {
	...
	/**
	 * One way to delay creation of the viewModel
	 * until an appropriate lifecycle method is to use lazy.
	 *
	 * This requires that viewModel not be referenced before onActivityCreated,
	 * which we do in this Fragment.
	 */
	 ...
	 * and fragment's view hierarchy has been created.
	 *
	 ...
	 * that can be used to inflate any views in the fragment,
	 *
	...
	override fun onCreateView(
		...
		viewModelAdapter = DevByteAdapter(VideoClick {
			...
			// context is not around, we can safely discard this click
			// since the Fragment is no longer on the screen

...
import com.codelab.dogglers.BaseTest.DrawableMatcher.hasItemCount
...
class GridListTests : BaseTest() {
	...
	@get:Rule
	var activityRule: ActivityScenarioRule<GridListActivity> = ActivityScenarioRule(GridListActivity::class.java)

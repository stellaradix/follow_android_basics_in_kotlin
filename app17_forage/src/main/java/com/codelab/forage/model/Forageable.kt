package com.codelab.forage.model
...
data class Forageable(
	...
	// TODO: make a custom column name for the inSeason variable
	//  that follows SQL column name conventions (the column name should be in_season)
